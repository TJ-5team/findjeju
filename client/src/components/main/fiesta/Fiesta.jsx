          ...
          <Swiper
            ...
            <SwiperSlide key={index}> 
              <div className={styles.festival}>
                <img className={styles.img} src={list.firstimage ? list.firstimage : "http://192.168.50.31:3000/images/bg_no_festival.png"} alt="축제이미지" />
              ...
              <>
                <SwiperSlide key="1"> 
                  <div className={`${styles.festival} ${styles.noImg}`}>
                    <img className={styles.img} src="http://192.168.50.31:3000/images/bg_no_festival.png" alt="" />
                  </div>
                </SwiperSlide>
                <SwiperSlide key="2"> 
                  <div className={`${styles.festival} ${styles.noImg}`}>
