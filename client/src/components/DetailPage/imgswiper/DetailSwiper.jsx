  ...
  return (
    <div className={styles.wrap}>
      ...
      >
        {imgDetail === undefined
          ...
          <div className={styles.swiperNoImageWrap}>
            <img src="http://192.168.50.31:3000/images/jeju_island.png" alt="" className={styles.swiperNoImage} />
      ...
      <button className={`${styles.prevBtn} prevBtn`}>
        <img src="http://192.168.50.31:3000/images/detailPage/btn_prev.png" alt="" />
      </button>
