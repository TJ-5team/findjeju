 ...
 */
  ...
  const imgList = () => {
    ...
    for (let index = 1; index < 12; index++) {
      if (index < 10) {
        index = '0' + index
        result.push(<img key={index} src={`http://192.168.50.31:3000/images/detailPage/icon_bfreesvc_${index}.png`} alt=""></img>);
      } else {
        result.push(<img key={index} src={`http://192.168.50.31:3000/images/detailPage/icon_bfreesvc_${index}.png`} alt=""></img>);
      }
    }
      ...
      <div className={`${styles.inner} inner`}>
        ...
        {/* <div>
          <h4 className={styles.titleInfo}>
            <div>
              <img src="http://192.168.50.31:3000/images/detailPage/ico_info.png" alt="" />
              모두의 여행 '무장애여행'
            </div>
          </h4>
